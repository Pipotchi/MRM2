...
public class LevelSpawner : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (transform.GetChild(transform.childCount - 1).GetComponent<Room>().roomnumber == 5)//specific roomnumbers for bosses
            {
                ...
                GameObject nextroom = Instantiate(roomtoadd, new Vector2(room.transform.position.x, room.transform.position.y + sprite1.bounds.extents.y + sprite2.bounds.extents.y - 0.6f), Quaternion.identity);
        ...
        {
            Camera.main.transform.position = Vector3.Lerp(Camera.main.transform.position, new Vector3(room.transform.position.x, room.transform.position.y, Camera.main.transform.position.z), camspeed *Time.deltaTime);
